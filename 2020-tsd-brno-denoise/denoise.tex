...
violated and the performance will suffer.
...
and Atlas (2002)\cite{gillespie2002diversity} deal with reverberation for
GMM-based ASR, Yoshioka et al. (2012)\cite{reverbmagazine} summarize various
dereverberation techniques, Ko et al. (2017)\cite{reverbaugment} attempt to
simlulate reverberation in training data digitally. Seltzer, Yu and Wang
(2013)\cite{dnnnoiserobust} deal with noise in DNN-based ASR.
...
\item{non-stationary interference like like background speech or door slams,}
\item{
...
The revolutionary article of Zhu et al. (2017)\cite{cyclegan} presenting
cycle-consistent generative adversarial networks gave mankind a mighty tool and
a hilarious tool that was used for de-hazing
...
in speech processing: Kaneko and Tameoka (2017)\cite{kaneko2017parallel} present
speech domain transfer and Hosseini-Asl et al.
(2018)\cite{hosseini2018malevoicegan} do the same for the purpose of speech
recognition.
...
I have used that proposed by Mandel \& Ellis (2005)\cite{mandel2005song}, which
...
I have used the voice transfer method as proposed by Kaneko \& Kameoka
(2017)\cite{kaneko2017parallel} and implemented by
